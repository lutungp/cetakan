...
class Ascii_Table
{
    ...
    public function alignright($kolom, $curr_tindakan_masuk, $marginright = 5)
    {
        $margin = $kolom - strlen($curr_tindakan_masuk) - $marginright;
        $marginlefttxt = '';
        for ($i=0; $i < $margin; $i++) {
            $marginlefttxt .= ' ';
        }
    ...
    public function alignleft($marginleft = 5, $curr_tindakan_masuk, $kolom)
    {
        $margin = $kolom - strlen($curr_tindakan_masuk) - $marginleft;
        $marginrighttxt = '';
        for ($i=0; $i < $margin; $i++) {
            $marginrighttxt .= ' ';
        }
